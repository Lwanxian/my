...
import Wpoint from '../components/wpoint.vue'

const routes = [
    { path: '/', name: 'index', component: Index },
    { path: '/e1', name: 'e1', component: E1 },
    { path: '/e2', name: 'e2', component: E2 },
    { path: '/eg12', name: 'eg12', component: Eg12 },
    { path: '/eg1301', name: 'eg1301', component: Eg1301 },
    { path: '/eg1302', name: 'eg1302', component: Eg1302},
    { path: '/eg1401', name: 'eg1401', component: Eg1401},
    { path: '/rewrite1', name: 'rewrite1', component: Rewrite1},
    { path: '/eg1901', name: 'eg1901', component: Eg1901},
    { path: '/wpoint', name: 'wpoint', component: Wpoint}
]
